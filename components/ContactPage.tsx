    ...
    return (
        <>
            ...
            <div ref={container} className="bg-white min-h-screen">
                {/* Hero Section */}
                <section className="min-h-screen flex items-center justify-center px-4 sm:px-10 md:px-20 pt-24 sm:pt-32">
                    <div className="max-w-350 w-full">
                        <motion.h1 
                            initial={{ opacity: 0, y: 100 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 1, ease: [0.76, 0, 0.24, 1] }}
                            className="text-[clamp(2.5rem,12vw,15vw)] font-oswald font-medium text-black leading-none mb-12 sm:mb-20"
                        >
                            ...
                            <div className="flex flex-col justify-between">
                                <div>
                                    ...
                                    <div className="space-y-6 text-black">
                                        <div>
                                            <p className="text-2xl font-light">nikhilesh1363@gmail.com</p>
                                        </div>
                                        <div>
